...
## Project Structure
    ...
    ├── sneh_figma_pp_test__22676  # Django project configurations
...
1. Clone this repo and `cd sneh_figma_pp_test__22676`
...
2. Clone this repo and `cd sneh_figma_pp_test__22676`
